...
export default function profile() {
  ...
  return (
    ...
    <div className="container" style={{display:'flex'}}>
      <div className="small-column"  style={{padding: '120px' ,border: '9px solid green' ,borderRadius :'35px',marginTop:'50px' ,width: '20%',display:'flex',flexDirection:'column',backgroundColor:'white' }}>
      ...
      {/* </div> */}
      <div className="big-column" style={{ width: '80%' ,display:'flex',flexDirection:'column',position:'relative',top:'10rem' }}>
